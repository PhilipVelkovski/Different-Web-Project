...
function lights(){ 
    ...
    var body_collor = document.body;
    var head_collor = document.getElementsByClassName("header");
   body_collor.classList.toggle("dark-mode");
   head_collor.classList.toggle("dark-mode");
  }
